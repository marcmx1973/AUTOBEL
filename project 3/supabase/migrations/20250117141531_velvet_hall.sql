/*
  # Correction complète du schéma de la base de données

  1. Modifications
    - Recréation des tables avec la structure correcte
    - Ajout des contraintes appropriées
...
-- Création de la table RFQ Planning
...
-- Création de la table RFQ Worksharing
